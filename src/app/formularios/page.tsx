...
const Formularios = (props: Props) => {
  const images = [
    FormularioAcesso, AvisoAlta, DiariaAcompanhante, FichaCuidado, FichaPreOp, FichaPed, FormularioVirusRespiratorio, GeracaoAIH, 
    InvestigacaoObito, ObitoFetal, ObitoInfantil, ObitoMaterno, PartoAdequado, RequisicaoExames, SES, TermoCsarea, TermoResponsabilidade,
    TransferenciaGestante, TransferenciaRN, TransferenciaSRAG, TransferenciaPadrao, TransferenciaPsiquiatrica]
