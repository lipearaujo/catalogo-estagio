...
const Login = (props: Props) => {
  ...
  return (
    <form className="m-auto w-[450px] h-[40vh] border border-[#263238] shadow-lg shadow-black rounded-lg bg-[#fff] flex flex-col gap-6 justify-center items-center">
      <input
        type="text"
        placeholder="E-mail..."
        value={inputText}
        onChange={getInputText}
        className="border-0 outline-0 rounded-[999px] bg-slate-300 pl-3 w-[18rem] h-[50px] focus:w-[22rem] focus:border-4 focus:border-slate-500 ease-in-out duration-300"
      />
      <input
        type="password"
        placeholder="Senha..."
