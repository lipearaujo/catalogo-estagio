...
const SidebarItem = ({ id, name, href, icon, color }: Props) => {
    ...
    const activeLinkStyle = `w-full tracking-wide flex py-4 pr-[1.25rem] text-sm justify-center items-center gap-8 text-center text-[#000] font-bold rounded-l-[9999px] bg-[#F1F5F9] ease-in-out duration-200`
